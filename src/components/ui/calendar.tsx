    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-opacity text-slate-200"
                ),
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-800 rounded-md transition-colors text-slate-300"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-primary text-white hover:bg-primary hover:text-white focus:bg-primary focus:text-white",
                day_today: "bg-slate-800/50 text-slate-100",
                day_outside:
                    "day-outside text-slate-700 opacity-50 aria-selected:bg-slate-800/50 aria-selected:text-slate-500 aria-selected:opacity-30",
            ...
            components={{
                ChevronLeft: ({ ...props }: any) => <ChevronLeft className="h-4 w-4" />,
                ChevronRight: ({ ...props }: any) => <ChevronRight className="h-4 w-4" />,
            } as any}
            {...props}
        />
    )
